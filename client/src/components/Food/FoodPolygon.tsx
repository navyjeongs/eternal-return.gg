...
// 연못 Polygon
const Poly2 = styled(Poly1).attrs(() => ({
  points:
...
// 모래사장 Polygon
const Poly3 = styled(Poly1).attrs(() => ({
  points:
...
// 고급 주택가 Polygon
const Poly4 = styled(Poly1).attrs(() => ({
  points:
...
// 골목길 Polygon
const Poly5 = styled(Poly1).attrs(() => ({
  points:
...
// 호텔 Polygon
const Poly6 = styled(Poly1).attrs(() => ({
  points:
...
// 번화가 Polygon
const Poly7 = styled(Poly1).attrs(() => ({
  points:
...
// 양궁장 Polygon
const Poly10 = styled(Poly1).attrs(() => ({
  points:
...
// 묘지 Polygon
const Poly11 = styled(Poly1).attrs(() => ({
  points:
...
// 숲 Polygon
const Poly12 = styled(Poly1).attrs(() => ({
  points:
